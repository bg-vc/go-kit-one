...
func main() {
	...
	hystrixRouter := NewRoutes(consulClient, zipKinTracer, "circuit breaker:service unavailable", logger)
	...
	go func() {
		errChan <- http.ListenAndServe(net.JoinHostPort("", "8010"), hystrixHandler)
	}()
